    ...
    public async Task HelpCommand(InteractionContext ctx)
    {
        var embed = new DiscordEmbedBuilder()
            ...
            .AddField("📜 Основные команды",
                ...
                🐟 `/loserboard` — топ 10 самых неудачных уловов
                🧬 `/myrarefish` — твои топ-3 самых редких рыбы
                📊 `/mystats` — твоя личная статистика
                🐠 `/fishofday` — какая рыба дня сегодня
                💰 `/wallet` — баланс чешуек и текущая удочка
                🛒 `/shop` — магазин удочек
            ...
            .AddField("Рыба дня",
                "Каждый день выбирается случайная рыба дня. Если поймаешь именно её, получишь бонус `x1.5` к очкам.")
            .AddField("⏱️ Кулдаун",
